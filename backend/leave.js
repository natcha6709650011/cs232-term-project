...
exports.handler = async (event) => {
    ...
    //ถ้าsessionหมดเวลาแล้วก็ลาไม่ได้
    ...
    //กันส่งซ้ำ
    const exitingAttendace = await dynamodb.get({
    ...
    return response(200, {
        success: true,
        message: "leavesubmitted successfully"
    });
    }catch(err){
